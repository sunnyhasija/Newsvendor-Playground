# 🤖 LLM Codebase Navigation Guide: Newsvendor Negotiation Experiment
...
### **If you want to MODIFY/REFACTOR:**
1. Start with the core files (⭐⭐⭐ rated)
2. Understand the flow: Model Manager → Agents → Conversation Tracker → Parsing
3. Test changes with debug files before running full experiments
4. Update configuration files for parameter changes
...
The project could be adapted for other negotiation scenarios or extended to test different AI capabilities and biases.

---

**Last Updated**: Based on codebase analysis as of current state
**Next Steps**: Use this guide to navigate efficiently and avoid analysis paralysis