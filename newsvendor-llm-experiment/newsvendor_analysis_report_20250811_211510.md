...
**Generated on:** 2025-08-11 21:15:10
**Data Source:** experiment_results/complete_results_study1.json
**Models Analyzed:** 10 models across 4 tiers
...
3. **Buyer Advantage:** $11.69 systematic advantage (Small effect (d = 0.358))
...
- **Optimal Price:** $62.9
- **Distance from Optimal:** $15.72
- **Buyer Advantage:** $11.69
...
|---------|-------------|---|--------------|------------|-----------------|
| 00 | No Reflection | 2,000 | 100.0% | $50.85 | $12.05 |
| 01 | Buyer Only | 2,000 | 100.0% | $46.56 | $16.34 |
| 10 | Supplier Only | 2,000 | 100.0% | $54.84 | $8.06 |
| 11 | Both Reflect | 2,000 | 100.0% | $52.43 | $10.47 |


### 3. Research Question 2: Model Size Effects

**Statistical Test:** F(8.480) = 8.480, p = 0.000, η² = 0.002
...
|------|----------------------|--------------------------|------------------------|
| Ultra | $55.43 | $40.82 | $14.78 |
| Compact | $55.47 | $50.06 | $10.13 |
| Mid-Range | $48.64 | $53.28 | $11.98 |
| Premium | $47.63 | $54.18 | $11.94 |


### 4. Research Question 3: Role Asymmetry (Buyer Advantage)

**Statistical Test:** t(30.900) = 30.900, p < 0.0001, d = 0.358

**Finding:** A systematic buyer advantage of **$11.69** emerged across all conditions. This represents a **small effect size**.
...
| qwen3 | Mid-Range | $44.26 | $58.48 | $-14.21 | Supplier-Generous |
...
- **Buyer Advantage:** d = 0.358 (small effect)
...
3. **Systematic Biases:** The pronounced buyer advantage ($11.69) reveals systematic biases in LLM training that favor certain negotiation roles.
...
### For Fairness
- The $11.69 buyer advantage represents a significant fairness concern
